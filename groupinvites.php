            ...
            <div class="col-md-10 col-md-offset-1">
              <div class="panel" style="padding: 10px;">
                <div class="panel-header">
                  <h3 class="panel-title" style="padding-top: 10px; padding-bottom: 10px; color: purple">Group Invites</h3>
...
?>
				...
				$result = mysql_query("SELECT * FROM groupinvite where invitee='$_SESSION[userid]' ORDER BY time DESC LIMIT 10");
				
					while($row = mysql_fetch_assoc($result))
					{
						$tfid = mysql_query("select * from profile where id='$row[inviter]'");
						$tfidresult = mysql_fetch_assoc($tfid);
						if(!empty($row['inviter'])){
					?>
						<tr style="text-align: left">
						  <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                          <td class="mailbox-name"><a href="invites.php?fid=<?php echo "$row[inviter]&$tfidresult[firstname]$tfidresult[lastname]"; ?>"></a></td>
                          <td class="mailbox-subject" style="font-size: 11px; font: arial; "><a href="invites.php?fid=<?php echo $row["inviter"]; ?>">
						  <?php $groupquery = mysql_query("select * from `$row[groupname]` where memberid = '$_SESSION[userid]'");
								$grow = mysql_fetch_assoc($groupquery);
								$grp = (strtolower($row['groupname']))
						  ?>
				<?php if(!$grow) { echo "<b style=\"color: red !important;\"> $tfidresult[firstname] invited you to join <span style='color: blue'>$grp</span></b>"; } ?> </a>
						  </td>
		...
		<?php		} 
					...
					{?>
                        <tr>
                          ...
                          <td class="mailbox-subject" style="text-align: center;">You have No Group Invites...</td>

...
$salt='3ke9d3do83jxwhzc';                          // Salt. A salt consists of random chars used as one of the inputs of a one-way function (MD5 hash). DO NOT CHANGE!
...
$dbss['name']='chatroom_mathematics';                  // Database name [mysql, postgre]. Note that the installation script cannot create a database for you!
$dbss['prfx']='maths';                  // Table prefix for BLAB! tables, default 'blab7'

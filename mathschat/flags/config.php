...
$salt='ed03qz2sef8922k9';                          // Salt. A salt consists of random chars used as one of the inputs of a one-way function (MD5 hash). DO NOT CHANGE!
...
$dbss['name']='freechat';                  // Database name [mysql, postgre]. Note that the installation script cannot create a database for you!
$dbss['prfx']='blab7';                  // Table prefix for BLAB! tables, default 'blab7'
...
$bwords=array('fuck','bitch','ass','motherfucker','sex');     // Bad words array: $bwords=array('fuck','bitch','etc');  $bwords=0; -> off. Turn it off to save CPU resources. 

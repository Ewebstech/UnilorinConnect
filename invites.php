...
if(isset($_REQUEST["fid"])) $fid = $_REQUEST["fid"];
		...
		$query1 = "SELECT * FROM groupinvite where invitee = '$_SESSION[userid]'";
		$result1 = mysql_query($query1);
		$invrow = mysql_fetch_assoc($result1);
...
?>
				...
				<div class="box-body no-padding">
                  <div class="mailbox-read-info">
                    <h3 style="font-size: 13px; color: purple; text-align: center"> <?php echo"<a href='mp.php?&profile=$row[id]&$row[firstname]$row[lastname]'>$row[firstname] $row[lastname]</a> wants you to join a group - <br /><a href='#'>$invrow[groupname]</a>";?></h3> <!-- Message Subject Is Placed Here -->
				...
				<tr><td >
				<a href="process.php?grpn=<?php $rand = rand(); echo"$invrow[groupname]&joingroup=$rand"; ?>" style="color: #fff;" class="btn btn-default btn-success btn-xs">Join</a>&nbsp;&nbsp;<a style="color: #fff;" href="groupinvites.php" class="btn btn-default btn-danger btn-xs">Discard</a>
				</td></tr>
				</table>

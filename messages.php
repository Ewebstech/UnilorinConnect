              ...
              <div class="panel" style="padding: 10px; margin-top: 10px;">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li><a class="btn btn-primary" href="messages.php"><i class="fa fa-inbox"></i> Inbox <span class="label label-primary pull-right" id="msgp"></span></a></li>
                    <br />
...
$next = $page + 10;
$total = 0;
$query = "SELECT * FROM mail WHERE reciever = '$_SESSION[username]'";
				...
				$page++;
					...
					?>
						<tr>
                          ...
                          <td class="mailbox-name"><a href="read.php?mid=<?php echo "$row[id]&$row[sendername]"; ?>"></a></td>
                          <td class="mailbox-subject"><a href="read.php?mid=<?php echo "$row[id]&$row[sendername];"; ?>">
